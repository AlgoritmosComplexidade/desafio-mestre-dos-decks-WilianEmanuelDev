...
// ====================================================================
// NÍVEL NOVATO — INSERTION SORT (Energia Crescente)
// ====================================================================
...
// ====================================================================
// NÍVEL AVENTUREIRO — SHELL SORT (Ataque Decrescente)
// ====================================================================
...
// ====================================================================
// NÍVEL MESTRE — QUICK SORT (Raridade ↓, Nome ↑)
// ====================================================================

// Função de comparação customizada
int compararCartas(const struct Carta* c1, const struct Carta* c2) {
    if (c1->raridade != c2->raridade) {
        return c2->raridade - c1->raridade; // Decrescente
    }
    return strcmp(c1->nome, c2->nome); // Crescente alfabético
}
